      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">Novo Local</h2>
            <button
              onClick={onClose}
          ...
          <p className="text-gray-600 mt-1 text-sm">Crie um novo local rapidamente</p>
        </div>
        ...
        <div className="px-6 py-4">
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                placeholder="Ex: Quadra de Futebol, Piscina..."
                value={nome}
